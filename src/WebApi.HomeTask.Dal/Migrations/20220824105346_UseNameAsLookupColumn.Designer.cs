...
namespace WebApi.HomeTask.Dal.Migrations
{
    ...
    [Migration("20220824105346_UseNameAsLookupColumn")]
    partial class UseNameAsLookupColumn
    {
            ...
            modelBuilder.Entity("WebApi.HomeTask.Dal.Entities.TableSizeEntity", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Name"), new[] { "PeopleCount" });

                    b.HasIndex("PeopleCount");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("PeopleCount"), new[] { "Name" });
