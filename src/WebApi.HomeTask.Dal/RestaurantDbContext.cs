...
public class RestaurantDbContext : DbContext
{
    ...
    /// <summary>
    ///     Gets or sets the group restaurants tables.
    /// </summary>
    ...
    {
        optionsBuilder.UseSqlServer(@"Server=tcp:webaspi-hometask-db-server.database.windows.net,1433;Initial Catalog=webapi-hometask-db;Persist Security Info=False;User ID=devtest;Password=Password123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
    }
}